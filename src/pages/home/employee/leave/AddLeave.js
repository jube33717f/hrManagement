...
const AddLeave = props=>{
    ...
    async function postMethod(newLeave){
        const res = (await postLeave(newLeave.name,Id, newLeave.leaveType,newLeave.dateStart,newLeave.dateEnd,newLeave.reason)).data
        return res.status;
    }
    function handleSubmit(event){
        postMethod(item);
        props.onChecked(load);    
...
export default connect(mapStateToProps, {loadUser})(AddLeave);
